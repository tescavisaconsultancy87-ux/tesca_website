...
const CSP = [
  ...
  "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://script.google.com https://api.web3forms.com https://api.emailjs.com https://www.google-analytics.com https://analytics.google.com https://*.analytics.google.com https://*.google-analytics.com https://www.google.com https://*.google.com https://stats.g.doubleclick.net https://*.doubleclick.net https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://us.i.posthog.com https://*.posthog.com https://app.posthog.com https://cloudflareinsights.com https://*.cloudflareinsights.com",
